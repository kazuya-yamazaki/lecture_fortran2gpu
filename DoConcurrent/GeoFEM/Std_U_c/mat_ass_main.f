...
c$$$      do icel0= ELMCOLORindex(icol-1)+1, ELMCOLORindex(icol)
     ...
     &            local   (icel,in1,in2,in3,in4,in5,in6,in7,in8)        &
     &            local   (in10,in20,in30,in40,in50,in60,in70,in80)     &
     &            local   (nodLOCAL,ie,je,ip,jp,kk,iiS,iiE,iDlu,k)      &
     &            local   (PNXi,PNYi,PNZi,PNXj,PNYj,PNZj,a11,a12)       &
     &            local   (a13,a21,a22,a23,a31,a32,a33,ipn,jpn,kpn,coef)&
     &            local   (DETJ,PNX,PNY,PNZ,X1,X2,X3,X4,X5,X6,X7,X8)    &

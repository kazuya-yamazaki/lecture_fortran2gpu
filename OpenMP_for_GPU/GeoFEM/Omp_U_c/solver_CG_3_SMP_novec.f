...
!$omp end target teams distribute parallel do
      ...
      BNRM20= 0.d0
!$omp target teams distribute parallel do reduction(+:BNRM20)
      do i= 1, 3*N
        BNRM20= BNRM20+B(i)**2
      enddo
!$omp end target teams distribute parallel do
...
!$omp target teams distribute parallel do reduction(+:RHO0)
      do i= 1, 3*N
...
!C===
      C10= 0.d0
!$omp target teams distribute parallel do reduction(+:C10)
      do i= 1, 3*N
...
!$omp end target teams distribute parallel do
      ...
      DNRM20= 0.d0
!$omp target teams distribute parallel do reduction(+:DNRM20)
      do i= 1, 3*N

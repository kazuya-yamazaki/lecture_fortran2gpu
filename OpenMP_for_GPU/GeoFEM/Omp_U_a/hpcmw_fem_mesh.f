...
!C-- COMM. TABLE
      integer          :: NEIBPETOT
      integer, dimension(0:26) :: NOD_STACK_IMPORT
      integer, dimension(0:26) :: NOD_STACK_EXPORT
      ! integer, dimension(300000*4):: NOD_IMPORT, NOD_EXPORT
      ! integer, dimension(300000*4):: NOD_EXPORT_NEW
      !(*) Memory for arrays below will be allocated in INPUT_GRID()
      integer, dimension(:), allocatable:: NOD_IMPORT
      integer, dimension(:), allocatable:: NOD_EXPORT
      integer, dimension(:), allocatable:: NOD_EXPORT_NEW
      integer, dimension(26)   :: NEIBPE
